...
''' TODO IMPROVEMENTS TO BE MADE BASED ON THE REPORT '''
...
def SCHEDULEConference(app, conferId, jobName):
    ...
    with app.app_context():
        ...
        for talk in talksFound:
            ...
            if popScore >= int(round((len(DelegateInfo) * 0.85))): 
        ...
        def TemporalDist(schedule, talk1):
            # Function to find the temporal distance between two talks
            pass
